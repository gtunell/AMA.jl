...
products = Product[
    LibraryProduct(prefix, "libarpack.so", :libfoo),
...
bin_prefix = "https://github.com/es335mathwiz/AMA.jl/tree/develop/deps"

download_info = Dict(
     Linux(:x86_64)          => ("$bin_prefix/libarpack.so", ""),  
     MacOS(:x86_64)          => ("$bin_prefix/libarpack.so", ""), 
